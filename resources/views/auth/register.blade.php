...
<head>
    ...
    <style>
        .custom-img {
            max-width: 60%;
            /* Maksimal lebar 60% dari kontainer */
            height: auto;
        ...
        <div class="d-flex flex-column" style="width: 100%;">
            ...
            <form method="POST" action="{{ route('register.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{ old('username') }}" id="username" name="username" placeholder="username" type="text"
                        required />
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control" value="{{ old('email') }}" id="email" name="email" placeholder="Email" type="email" required />
                </div>
                <div class="form-group">
